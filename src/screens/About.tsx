...
const timelineData: TimelineItem[] = [
  ...
  { year: "2025", title: "Rumo à carreira de dev", text: "Desde então, venho participando de novos projetos como freelancer, expandindo meus conhecimentos também em backend e atualmente atuo como estagiário em suporte técnico. Estou em busca da minha primeira oportunidade efetiva como desenvolvedor fullstack ou analista de dados." },
];
      ...
      {timelineData.map((item, index) => {
        ...
        return (
          ...
          > 
            ...
            <div className={`p-4 rounded-lg transition-all duration-300 hover:-translate-y-8
